...
export const hi: Dictionary = {
  ...
  routing: {
    ...
    laneHuman: "व्यक्ति के पास भेजा",
    lanePostponed: "स्थगित",
    laneInFlight: "अभी भी प्रक्रिया में",
    reasonsLabel: "केस मॉडल के पास क्यों गए",
    share: "बुक का {pct}",
  },
  ...
  sim: {
    ...
    delete: "हटाएँ",
    runLive: "लाइव चलाएँ ▸",
    runLiveFailed: "लाइव सत्र शुरू नहीं हो सका",
  ...
  guardrails: {
    title: "गार्डरेल्स",
    subtitle:
      "इंजन जिन सीमाओं के भीतर काम करता है। पॉलिसी ट्यून करें, कोई कार्रवाई चलने से पहले जाँचें, और ह्यूमन कतार साफ़ करें.",

    policyTitle: "पॉलिसी",
    policyDesc: "पैसे हिलाने वाली हर कार्रवाई यह गेट पास करती है। बदलाव अगली कार्रवाई पर तुरंत लागू होते हैं.",
    maxDiscount: "अधिकतम छूट",
    maxIntervention: "अधिकतम हस्तक्षेप राशि",
    allowPartial: "आंशिक भुगतान की अनुमति",
    minPartial: "न्यूनतम पहला आंशिक",
    channels: "अनुमत चैनल",
    allowedActions: "अनुमत कार्रवाइयाँ",
    moneyMoving: "पैसा हिलाता है",
    savePolicy: "पॉलिसी सहेजें",
    savingPolicy: "सहेजा जा रहा है…",
    policySaved: "पॉलिसी अपडेट हुई",
    policySaveFailed: "पॉलिसी सहेजी नहीं जा सकी",
    discardChanges: "बदलाव रद्द करें",
    noChanges: "कोई बिना सहेजा बदलाव नहीं",

    rulesTitle: "स्टॉपिंग नियम",
    rulesDesc: "गैर-परक्राम्य। पॉलिसी चाहे जो हो, ये इंजन को रोक देते हैं.",

    sandboxTitle: "पॉलिसी सैंडबॉक्स",
    sandboxDesc: "किसी प्रस्तावित कार्रवाई या ग्राहक संदेश को असली गेट से चलाएँ — वही जो हर रिकवरी चरण पास करता है.",
    tabAction: "कार्रवाई जाँचें",
    tabMessage: "संदेश स्क्रीन करें",
    fAction: "कार्रवाई",
    fChannel: "चैनल",
    fDiscount: "छूट %",
    fAmount: "राशि (₹)",
    anyChannel: "कोई भी",
    checkAction: "कार्रवाई जाँचें",
    checking: "जाँचा जा रहा है…",
    approved: "स्वीकृत",
    rejected: "अस्वीकृत",
    fMessage: "ग्राहक संदेश",
    messagePlaceholder: "जैसे: band karo, ab message mat bhejna",
    screenMessage: "संदेश स्क्रीन करें",
    disposition: { CONTINUE: "जारी रखें", TERMINATE: "समाप्त करें", ESCALATE: "एस्केलेट करें" },
    matchedRule: "{rule} से मेल",

    queueTitle: "एस्केलेशन कतार",
    queueDesc: "जो केस इंजन ने इंसान को सौंपे.",
    queueEmpty: "किसी इंसान के लिए कुछ लंबित नहीं.",
    resolveTicket: "हल किया चिह्नित करें",
    resolving: "हल किया जा रहा है…",
    ticketResolved: "एस्केलेशन हल हुआ",
    ticketResolveFailed: "वह एस्केलेशन हल नहीं हो सका",
    ticket: "टिकट #{id}",
    openTickets: "{count} खुले",
  },

  audit: {
    title: "ऑडिट ट्रेल",
    subtitle: "इंजन ने लिखी हर पंक्ति, उस नोड के अनुसार समूहीकृत जिसने उसे लिखा। नवीनतम पहले.",
    filterLabel: "ट्रांज़ैक्शन से फ़िल्टर करें",
  ...
  live: {
    title: "लाइव सत्र",
    exit: "कंसोल पर वापस जाएँ",
    agentColumn: "एजेंट",
    stageColumn: "स्टेज",
    connecting: "कनेक्ट हो रहा है…",
    notFoundTitle: "यह सत्र सक्रिय नहीं है",
    notFoundBody: "इस लिंक का सत्र चल नहीं रहा। कंसोल से नया सत्र शुरू करें।",
    backToConsole: "कंसोल पर वापस जाएँ",
    sessionEnded: "सत्र समाप्त — {status}",

    routeTitle: "मॉडल रूट",
    routeSeeded: "प्रारंभिक — पूर्वनिर्धारित",
    routeSeededHint: "एक निश्चित श्रेणी डिफ़ॉल्ट — इस चरण में कोई मॉडल कॉल नहीं हुई।",
    raisedBy: "{reasons} के कारण बढ़ाया गया",
    raise_stakes: "राशि",
    ...
    askedFor: "माँगा गया",
    sandboxRefused: "सैंडबॉक्स ने मना किया",
    handedOffTo: "सौंपा गया",
    discountLabel: "छूट {pct}%",
    scheduledFor: "{when} के लिए निर्धारित",
    ...
    callEnd: "कॉल समाप्त करें",
    callSpeaking: "एजेंट बोल रहा है",
    callListening: "आपको सुन रहे हैं…",
    ...
    online: "ऑनलाइन",
    composerPlaceholder: "ग्राहक की तरह लिखें…",
    composerLabel: "ग्राहक के रूप में जवाब दें",
    send: "भेजें",
    agentTyping: "एजेंट टाइप कर रहा है…",
